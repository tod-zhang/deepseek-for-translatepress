...
class ArrayHelper
{
     ...
     * @throws InvalidArgumentException if the $descending or $sortFlag parameters do not have
    ...
    public static function multisort(&$array, $key, $direction = SORT_ASC, $sortFlag = SORT_REGULAR)
    {
        ...
        if (is_scalar($direction)) {
            ...
            throw new InvalidArgumentException('The length of $descending parameter must be the same as that of $keys.');
        }
